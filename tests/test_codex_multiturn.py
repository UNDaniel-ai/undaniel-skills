"""
Opt-in integration tests for Codex multi-turn skill behavior.
"""
...
FIXTURE_DIR = Path(__file__).resolve().parent / "fixtures" / "multiturn"
...
def test_codex_multiturn_fixture(fixture_path: Path):
    """Each multi-turn fixture should keep the expected skill markers across resumed session turns."""
